...
rm -rf packages/dts-decoder/dist
...
api-extractor run -c packages/dts-decoder/api-extractor.json
...
tsx scripts/check-docblocks.ts packages/dts-decoder/dist/mediabunny-dts-decoder.d.ts
...
echo 'export as namespace MediabunnyDtsDecoder;' >> packages/dts-decoder/dist/mediabunny-dts-decoder.d.ts
